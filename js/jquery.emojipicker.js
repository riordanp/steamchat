  ...
  $.extend(Plugin.prototype, {
    ...
    addPickerIcon: function() {
      ...
      if (this.settings.button) {
        this.$icon = $('<div class="emojiPickerIcon"></div>')
          ...
          .css({'backgroundColor':this.settings.iconBackgroundColor, 'border-top':'1px solid #ccc', 'border-right': '1px solid #ccc'})
    ...
    updatePosition: function() {
      ...
      if (this.settings.container === 'body') {
          top = this.$el.offset().top - this.$el.height() - this.settings.height + 70;
          left = this.$el.offset().left;
      }
      else {
          top = this.$el.position().top - this.$el.height() - this.settings.height + 70;
